 ...
 */
public final class LteRanNeighborListInUseCustomizer implements
    ...
    public LteRanNeighborListInUseCustomizer(final CrudService<LteRanNeighborListInUse> crudService) {
        this.crudService = crudService;
        LOG.info("RANSIM LteRanNeighborListInUseCustomizer ctor called");
    }

    @Override
        public void merge(Builder<? extends DataObject> parentBuilder, LteRanNeighborListInUse readValue) {
    ...
    @Nonnull
    @Override
    public LteRanNeighborListInUseBuilder getBuilder(@Nonnull final InstanceIdentifier<LteRanNeighborListInUse> id) {
    ...
    @Override
    public void readCurrentAttributes(@Nonnull final InstanceIdentifier<LteRanNeighborListInUse> id,
        ...
        // perform read of details of data specified by key of LteRanNeighborListInUse in id
