...
public class WebsocketClient {
    ...
    public WebsocketClient(String ransimIp, int ransimPort, String hcIp, int hcPort,
                           String endpoint, String vesEventListenerUrl){
    ...
    public void OnClose(CloseReason reason, Session session){
        LOG.info("Websocket {} closed. Close reason {}. If closed unintentionally, Retrying...", session.getId(), reason.getReasonPhrase());
        clientSession = null;
    ...
    public void onMessage(DeviceData deviceData, Session session){
        try{
            if (deviceData != null){
                ...
                LOG.info("Message Received: Type:{}, msg:{}, Session Id:{}", type, deviceData.getMessage(), session.getId());
