...
public class NRCellDURRMPolicyRatioAttrCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public NRCellDURRMPolicyRatioAttrCustomizer(@Nonnull final CrudService<Attributes> crudService) {
