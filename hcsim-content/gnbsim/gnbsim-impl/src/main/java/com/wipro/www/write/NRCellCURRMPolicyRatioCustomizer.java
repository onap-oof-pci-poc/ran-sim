...
public class NRCellCURRMPolicyRatioCustomizer implements ListWriterCustomizer<RRMPolicyRatio, RRMPolicyRatioKey> {

    private final CrudService<RRMPolicyRatio> crudService;

    public NRCellCURRMPolicyRatioCustomizer(@Nonnull final CrudService<RRMPolicyRatio> crudService){
