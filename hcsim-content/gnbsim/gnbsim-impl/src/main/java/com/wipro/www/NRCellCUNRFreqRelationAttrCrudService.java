...
public class NRCellCUNRFreqRelationAttrCrudService implements CrudService<Attributes> {

    private static final Logger LOG = LoggerFactory.getLogger(NRCellCUNRFreqRelationAttrCrudService.class);
