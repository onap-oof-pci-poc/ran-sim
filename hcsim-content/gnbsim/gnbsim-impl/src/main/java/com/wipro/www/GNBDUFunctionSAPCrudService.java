...
public class GNBDUFunctionSAPCrudService implements CrudService<SAP> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(GNBDUFunctionSAPCrudService.class);

    @Override
    public void writeData(@Nonnull InstanceIdentifier<SAP> identifier, @Nonnull SAP data) throws WriteFailedException {
        if (data != null) {
    ...
    @Override
    public void deleteData(@Nonnull InstanceIdentifier<SAP> identifier, @Nonnull SAP data) throws WriteFailedException {
        if (data != null) {
    ...
    @Override
    public SAP readSpecific(@Nonnull InstanceIdentifier<SAP> identifier) throws ReadFailedException {
    ...
    @Override
    public List<SAP> readAll() throws ReadFailedException {
        return null;
    }
}
