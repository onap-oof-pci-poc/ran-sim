...
public final class Module extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(new TypeLiteral<CrudService<RanNetwork>>() {}).annotatedWith(Names.named(RANNETWORK_SERVICE_NAME))
                .to(RanNetworkCrudService.class);

        bind(new TypeLiteral<CrudService<NearRTRIC>>() {}).annotatedWith(Names.named(NEARRTRIC_SERVICE_NAME))
        ...
        WebsocketClient websocketClient =
                new WebsocketClient(configuration.getRansimIp(), configuration.getRansimPort(), configuration.getHcIp(),
                        configuration.getHcPort(), configuration.getEndpoint(), configuration.getVesEventListenerUrl());
