...
public class GNBDUFunctionAttributesCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public  GNBDUFunctionAttributesCustomizer(@Nonnull final CrudService<Attributes> crudService){
