...
public class GNBCUCPFunctionRRMPolicyRatioAttrCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public GNBCUCPFunctionRRMPolicyRatioAttrCustomizer(@Nonnull final CrudService<Attributes> crudService) {
