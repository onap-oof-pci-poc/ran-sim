...
public class GNBCUCPFunctionRRMPolicyRatioCustomizer implements ListWriterCustomizer<RRMPolicyRatio, RRMPolicyRatioKey> {

    private final CrudService<RRMPolicyRatio> crudService;

    public GNBCUCPFunctionRRMPolicyRatioCustomizer(@Nonnull final CrudService<RRMPolicyRatio> crudService){
