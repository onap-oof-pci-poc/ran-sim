...
public class GNBCUCPFunctionAttributesCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public GNBCUCPFunctionAttributesCustomizer(@Nonnull final CrudService<Attributes> crudService) {
