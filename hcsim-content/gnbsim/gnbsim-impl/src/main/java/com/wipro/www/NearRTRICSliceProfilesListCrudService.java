...
public class NearRTRICSliceProfilesListCrudService implements CrudService<SliceProfilesList> {
    ...
    @Override
    public void writeData(@Nonnull InstanceIdentifier<SliceProfilesList> identifier, @Nonnull SliceProfilesList data)
    ...
    @Override
    public void deleteData(@Nonnull InstanceIdentifier<SliceProfilesList> identifier, @Nonnull SliceProfilesList data)
            throws WriteFailedException {
        if (data != null) {
    ...
    @Override
    public void updateData(@Nonnull InstanceIdentifier<SliceProfilesList> identifier,
            @Nonnull SliceProfilesList dataOld, @Nonnull SliceProfilesList dataNew) throws WriteFailedException {
    ...
    @Override
    public SliceProfilesList readSpecific(@Nonnull InstanceIdentifier<SliceProfilesList> identifier)
