...
public class GNBDUFunctionNRCellDUCrudService implements CrudService<NRCellDU> {
    ...
    @Override
    public void writeData(@Nonnull InstanceIdentifier<NRCellDU> identifier, @Nonnull NRCellDU data)
    ...
    @Override
    public void deleteData(@Nonnull InstanceIdentifier<NRCellDU> identifier, @Nonnull NRCellDU data)
            throws WriteFailedException {
        if (data != null) {
    ...
    @Override
    public void updateData(@Nonnull InstanceIdentifier<NRCellDU> identifier, @Nonnull NRCellDU dataOld,
            @Nonnull NRCellDU dataNew) throws WriteFailedException {
    ...
    public NRCellDU readSpecific(@Nonnull InstanceIdentifier<NRCellDU> identifier) throws ReadFailedException {
        ...
        if (isDataReady == true) {
            ...
            org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.OperationalState opState =
                    org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.OperationalState.DISABLED;
            org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.CellState clState =
                    org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.CellState.IDLE;
            ...
            switch (iOpValue) {
                ...
                case 1:
                    opState =
                            org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.OperationalState.ENABLED;
                    break;
            }
            ...
            switch (iClValue) {
                ...
                case 1:
                    clState =
                            org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.CellState.INACTIVE;
                    break;
                case 2:
                    clState =
                            org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.CellState.ACTIVE;
                    break;
            }
            ...
            final Attributes attributes =
                    new AttributesBuilder().setOperationalState(opState).setCellState(clState).build();

            return new NRCellDUBuilder().setIdNRCellDU(key.getIdNRCellDU()).setAttributes(attributes).build();
        } else {
    ...
    public List<NRCellDU> readAll() throws ReadFailedException {
        ...
        try {
            for (int i = 0; i < listNearRTRIC.size(); i++) {
                ...
                List<com.wipro.www.websocket.models.NRCellDU> inputNRCellDUList =
                        new ArrayList<com.wipro.www.websocket.models.NRCellDU>();
                            ...
                            if (hm.getValue() == 0) {
                                ...
                                for (int m = 0; m < inputNRCellDUList.size(); m++) {
                                    ...
                                    outList.add(readSpecific(InstanceIdentifier.create(RanNetwork.class)
                                            ...
                                            .child(NRCellDU.class, new NRCellDUKey(idNRCellDU))));
                ...
                // outList.add(readSpecific(InstanceIdentifier.create(RanNetwork.class).child(NearRTRIC.class, new
                // NearRTRICKey(idNearRTRIC)).child(GNBDUFunction.class, new GNBDUFunctionKey(idGNBDUFunction))));
                if (isDataReady == true) {
                    break;
                }
        ...
        // NearRTRICKey("RTRIC2")).child(GNBDUFunction.class, new GNBDUFunctionKey("GNBDUFUN2")).child(NRCellDU.class,
        // new NRCellDUKey("NRCELL1"))));
    }
