...
public class NRCellCURRMPolicyRatioAttrCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public NRCellCURRMPolicyRatioAttrCustomizer(@Nonnull final CrudService<Attributes> crudService) {
