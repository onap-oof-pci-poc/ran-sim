...
public class GNBCUCPFunctionNRCellCUCrudService implements CrudService<NRCellCU> {
    ...
    @Override
    public NRCellCU readSpecific(@Nonnull InstanceIdentifier<NRCellCU> identifier) throws ReadFailedException {
    ...
    @Override
    public List<NRCellCU> readAll() throws ReadFailedException {
        return null;
    }
}
