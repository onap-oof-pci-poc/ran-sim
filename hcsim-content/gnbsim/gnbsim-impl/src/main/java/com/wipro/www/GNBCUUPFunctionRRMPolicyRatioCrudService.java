...
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.gnbcuupfunctiongroup.RRMPolicyRatioBuilder;
...
public class GNBCUUPFunctionRRMPolicyRatioCrudService implements CrudService<RRMPolicyRatio> {

    private static final Logger LOG = LoggerFactory.getLogger(GNBCUUPFunctionRRMPolicyRatioCrudService.class);
