...
public class GNBCUCPPLMNIdFunctionCrudService implements CrudService<PLMNId> {
    ...
    @Override
    public PLMNId readSpecific(@Nonnull InstanceIdentifier<PLMNId> identifier) throws ReadFailedException {
    ...
    @Override
    public List<PLMNId> readAll() throws ReadFailedException {
        return null;
    }
}
