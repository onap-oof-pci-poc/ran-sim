...
public class NearRTRICConfigCrudService implements CrudService<ConfigData> {
    ...
    @Override
    public void writeData(@Nonnull InstanceIdentifier<ConfigData> identifier, @Nonnull ConfigData data) throws WriteFailedException {
        if (data != null) {
    ...
    @Override
    public void deleteData(@Nonnull InstanceIdentifier<ConfigData> identifier, @Nonnull ConfigData data) throws WriteFailedException {
        if (data != null) {
    ...
    @Override
    public void updateData(@Nonnull InstanceIdentifier<ConfigData> identifier, @Nonnull ConfigData dataOld, @Nonnull ConfigData dataNew) throws WriteFailedException {
