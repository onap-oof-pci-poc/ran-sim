...
public class GNBCUUPFunctionRRMPolicyRatioAttrCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public GNBCUUPFunctionRRMPolicyRatioAttrCustomizer(@Nonnull final CrudService<Attributes> crudService) {
