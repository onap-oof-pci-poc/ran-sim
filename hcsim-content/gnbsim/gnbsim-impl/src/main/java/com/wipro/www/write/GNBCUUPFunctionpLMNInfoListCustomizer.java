...
public class GNBCUUPFunctionpLMNInfoListCustomizer implements ListWriterCustomizer<PLMNInfoList, PLMNInfoListKey> {

    private final CrudService<PLMNInfoList> crudService;

    public GNBCUUPFunctionpLMNInfoListCustomizer(@Nonnull final CrudService<PLMNInfoList> crudService){
