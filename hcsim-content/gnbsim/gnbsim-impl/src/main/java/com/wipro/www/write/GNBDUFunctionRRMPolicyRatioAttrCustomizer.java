...
public class GNBDUFunctionRRMPolicyRatioAttrCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public  GNBDUFunctionRRMPolicyRatioAttrCustomizer(@Nonnull final CrudService<Attributes> crudService){
