...
public class NRCELLCUAttributesCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public NRCELLCUAttributesCustomizer(@Nonnull final CrudService<Attributes> crudService) {
