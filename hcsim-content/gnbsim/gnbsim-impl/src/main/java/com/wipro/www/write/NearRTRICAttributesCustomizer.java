...
public class NearRTRICAttributesCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public NearRTRICAttributesCustomizer(@Nonnull final CrudService<Attributes> crudService) {
