...
public class GNBCUUPFunctionAttributesCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public GNBCUUPFunctionAttributesCustomizer(@Nonnull final CrudService<Attributes> crudService) {
