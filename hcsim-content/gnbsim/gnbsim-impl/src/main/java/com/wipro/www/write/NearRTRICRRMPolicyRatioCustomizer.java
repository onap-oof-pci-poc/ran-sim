...
public class NearRTRICRRMPolicyRatioCustomizer implements ListWriterCustomizer<RRMPolicyRatio, RRMPolicyRatioKey> {

    private final CrudService<RRMPolicyRatio> crudService;

    public NearRTRICRRMPolicyRatioCustomizer(@Nonnull final CrudService<RRMPolicyRatio> crudService){
