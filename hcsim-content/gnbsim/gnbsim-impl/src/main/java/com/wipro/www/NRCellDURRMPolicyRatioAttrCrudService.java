...
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.nrcelldugroup.rrmpolicyratio.Attributes;
...
public class NRCellDURRMPolicyRatioAttrCrudService implements CrudService<Attributes> {

    private static final Logger LOG = LoggerFactory.getLogger(NRCellDURRMPolicyRatioAttrCrudService.class);
