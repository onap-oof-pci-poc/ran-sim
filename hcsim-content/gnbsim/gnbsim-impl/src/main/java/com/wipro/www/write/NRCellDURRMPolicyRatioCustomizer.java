...
public class NRCellDURRMPolicyRatioCustomizer implements ListWriterCustomizer<RRMPolicyRatio, RRMPolicyRatioKey> {

    private final CrudService<RRMPolicyRatio> crudService;

    public NRCellDURRMPolicyRatioCustomizer(@Nonnull final CrudService<RRMPolicyRatio> crudService){
