...
public class NRCellDUpLMNInfoListCustomizer implements ListWriterCustomizer<PLMNInfoList, PLMNInfoListKey> {

    private final CrudService<PLMNInfoList> crudService;

    public NRCellDUpLMNInfoListCustomizer(@Nonnull final CrudService<PLMNInfoList> crudService) {
