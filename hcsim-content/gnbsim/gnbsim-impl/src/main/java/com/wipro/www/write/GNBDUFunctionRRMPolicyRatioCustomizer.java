...
public class GNBDUFunctionRRMPolicyRatioCustomizer implements ListWriterCustomizer<RRMPolicyRatio, RRMPolicyRatioKey> {

    private final CrudService<RRMPolicyRatio> crudService;

    public GNBDUFunctionRRMPolicyRatioCustomizer(@Nonnull final CrudService<RRMPolicyRatio> crudService) {
