...
import org.opendaylight.yang.gen.v1.org.onap.ccsdk.features.sdnr.northbound.ran.network.rev200806.nrcellcugroup.rrmpolicyratio.Attributes;
...
public class NRCellCURRMPolicyRatioAttrCrudService implements CrudService<Attributes> {

    private static final Logger LOG = LoggerFactory.getLogger(NRCellCURRMPolicyRatioAttrCrudService.class);
    ...
    public void writeData(@Nonnull InstanceIdentifier<Attributes> identifier, @Nonnull Attributes data) throws WriteFailedException {
        if (data != null) {
            ...
            rrmPolicyRatioModel.setRrmPolicyID(Integer.parseInt(idRRMPolicyRatio));
