...
public class NRCellCUNRCellRelationAttrCustomizer implements WriterCustomizer<Attributes> {

    private final CrudService<Attributes> crudService;

    public NRCellCUNRCellRelationAttrCustomizer(@Nonnull final CrudService<Attributes> crudService) {
